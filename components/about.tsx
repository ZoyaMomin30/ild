    ...
    <section id="about" className="py-24 bg-muted/30" ref={ref}>
      <div className="container space-y-12">
        ...
        >
          ...
          <p className="text-xl text-muted-gray max-w-[65rem] mx-auto">
